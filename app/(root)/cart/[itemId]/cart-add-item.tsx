                ...
                <div className='grid grid-cols-1 md:grid-cols-2 md:gap-4'>
                      <Card className='w-full rounded-none'>
                            <CardContent className='flex h-full items-center justify-center  gap-3 py-4'>
                                  ...
                                  <div>
                                        <h3 className='my-2 flex gap-2 text-xl font-bold'>
                                              <CheckCircle2Icon className='size-6 text-green-700' />
                                              Added to cart
                                        </h3>
                                        <p className='text-sm'>
                      ...
                      <Card className='w-full rounded-none'>
                          ...
                          <span className='text-green-700'>
                            Your order qualifies for FREE Shipping.
                                        ...
                                        <div className='flex flex-col items-center gap-3 lg:border-l lg:border-muted lg:pl-3  '>
